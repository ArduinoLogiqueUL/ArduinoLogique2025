...
cell_size_menu = (24, 24)
cursor_menu = pygame.transform.scale(cursor_menu, cell_size_menu)
gfx.canvas.blit(cursor_menu, (12,12))
...
cell_size_menu = (24, 24)
save_menu = pygame.transform.scale(save_menu, cell_size_menu)
gfx.canvas.blit(save_menu, (12,57))

flag_menu = pygame.image.load("Images/icons/flag_menu_blue24.png").convert_alpha()  
cell_size_menu = (24, 24)
flag_menu = pygame.transform.scale(flag_menu, cell_size_menu)
gfx.canvas.blit(flag_menu, (12,147))

chip_menu = pygame.image.load("Images/icons/chip_menu_blue.png").convert_alpha()  
cell_size_menu = (24, 24)
chip_menu = pygame.transform.scale(chip_menu, cell_size_menu)
gfx.canvas.blit(chip_menu, (12,192))
